...
echo "Generating tools README for src/universal_mcp_google_drive/app.py..."
universal_mcp readme src/universal_mcp_google_drive/app.py

# Stage the changed file
git add pyproject.toml src/universal_mcp_google_drive/README.md
